  ...
  (0, _createClass2["default"])(Client, [{
    ...
    value: function () {
      ...
      _regenerator["default"].mark(function _callee3(address) {
        var addr, addrHex, res, result, bytes, _decoder$unMarshalBin3, accountInfo, bech32Prefix;

        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                addr = crypto.decodeAddress(address);
                addrHex = Buffer.concat([Buffer.from("account:"), addr]);
                _context3.next = 4;
                return this.abciQuery({
                  path: "/store/acc/key",
                  data: addrHex
