...
const Popover = React.forwardRef(function Popover(props, ref) {
  ...
  const getAnchorOffset = React.useCallback(contentAnchorOffset => {
    ...
    const anchorElement = resolvedAnchorEl instanceof Element ? resolvedAnchorEl : ownerDocument(paperRef.current).body;
  ...
  const setPositioningStyles = React.useCallback(element => {
